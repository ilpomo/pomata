"""
Dtype-uniformity contract for the public pnl factories.
...
``test_output_is_float64`` parametrizes over ``pomata.pnl.__all__`` x {Float32, Int64}, so the guarantee covers the
