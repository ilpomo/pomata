...
VOLATILITY = Spec(
    ...
    # volatility(k*r) == |k|*volatility(r): degree-1 homogeneous
    ...
    pins=(
        ...
        SpecPin(
            ...
            "the near-constant regime; the property tiers' absolute band absorbs the rounding-noise dispersion "
            "there, so no conditioning filter is declared",
        ),
        SpecPin(
