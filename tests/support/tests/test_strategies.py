"""
Self-tests of :mod:`tests.support.strategies` — the live element domains the single-input fuzz path draws from.
...
from tests.support.strategies import FLOOR_SUBNORMAL, finite_floats, missing_data_floats
