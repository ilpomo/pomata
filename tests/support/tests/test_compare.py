"""
Self-tests of :mod:`tests.support.compare` — the three-way comparator and its non-raising probe.
...
from tests.support.compare import assert_matches, assert_scale_homogeneous, first_mismatch
