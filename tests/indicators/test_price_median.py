...
class TestPriceMedianContract:
    ...
    def test_returns_expr(self) -> None:
        ...
        """
        assert isinstance(price_median(pl.col(HIGH), pl.col(LOW)), pl.Expr)
    ...
    def test_preserves_length_and_dtype(self) -> None:
        ...
        result = frame.select(price_median(pl.col(HIGH), pl.col(LOW)).alias("y"))
    ...
    def test_lazy_eager_parity(self) -> None:
        ...
        expr = price_median(pl.col(HIGH), pl.col(LOW)).alias("y")
...
class TestPriceMedianEdge:
    ...
    def test_empty(self) -> None:
        ...
        """
        assert_matches(apply_price_median([], []), [])
