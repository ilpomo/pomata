...
oracle agreement (see ``CORRECTNESS.md``). They target the semantics of Polars 1.40.0 (the project's floor); each
docstring states the definition, the subtle points the reimplementation must reproduce, and its null / NaN / degeneracy
contract. This package re-exports them flat, mirroring
...
from tests.indicators.oracles.aroon_oscillator import aroon_oscillator_reference
from tests.indicators.oracles.atr import atr_reference
from tests.indicators.oracles.atr_normalized import atr_normalized_reference
from tests.indicators.oracles.awesome_oscillator import awesome_oscillator_reference
from tests.indicators.oracles.balance_of_power import balance_of_power_reference
from tests.indicators.oracles.bollinger_bands import bollinger_bands_reference
from tests.indicators.oracles.cci import cci_reference
from tests.indicators.oracles.chaikin_money_flow import chaikin_money_flow_reference
from tests.indicators.oracles.chande_momentum_oscillator import chande_momentum_oscillator_reference
...
from tests.indicators.oracles.dema import dema_reference
...
from tests.indicators.oracles.dm_plus import dm_plus_reference
from tests.indicators.oracles.donchian_channels import donchian_channels_reference
from tests.indicators.oracles.dx import dx_reference
from tests.indicators.oracles.ema import ema_reference
from tests.indicators.oracles.fisher_transform import fisher_transform_reference
from tests.indicators.oracles.hma import hma_reference
from tests.indicators.oracles.ichimoku import ichimoku_reference
from tests.indicators.oracles.kama import kama_reference
from tests.indicators.oracles.keltner_channels import keltner_channels_reference
from tests.indicators.oracles.linear_regression import linear_regression_reference
from tests.indicators.oracles.linear_regression_angle import linear_regression_angle_reference
from tests.indicators.oracles.linear_regression_intercept import linear_regression_intercept_reference
from tests.indicators.oracles.linear_regression_slope import linear_regression_slope_reference
from tests.indicators.oracles.macd import macd_reference
from tests.indicators.oracles.midpoint import midpoint_reference
from tests.indicators.oracles.midprice import midprice_reference
from tests.indicators.oracles.mom import mom_reference
from tests.indicators.oracles.money_flow_index import money_flow_index_reference
from tests.indicators.oracles.obv import obv_reference
from tests.indicators.oracles.parabolic_sar import parabolic_sar_reference
from tests.indicators.oracles.percentage_price_oscillator import percentage_price_oscillator_reference
from tests.indicators.oracles.price_average import price_average_reference
...
from tests.indicators.oracles.price_weighted_close import price_weighted_close_reference
...
from tests.indicators.oracles.rsi_stochastic import rsi_stochastic_reference
from tests.indicators.oracles.sma import sma_reference
from tests.indicators.oracles.standard_deviation_ewma import standard_deviation_ewma_reference
...
from tests.indicators.oracles.stochastic_slow import stochastic_slow_reference
from tests.indicators.oracles.supertrend import supertrend_reference
from tests.indicators.oracles.t3 import t3_reference
from tests.indicators.oracles.tema import tema_reference
from tests.indicators.oracles.time_series_forecast import time_series_forecast_reference
from tests.indicators.oracles.trima import trima_reference
from tests.indicators.oracles.trix import trix_reference
from tests.indicators.oracles.true_range import true_range_reference
from tests.indicators.oracles.ultimate_oscillator import ultimate_oscillator_reference
...
from tests.indicators.oracles.vortex import vortex_reference
from tests.indicators.oracles.vwap import vwap_reference
from tests.indicators.oracles.vwma import vwma_reference
from tests.indicators.oracles.williams_r import williams_r_reference
