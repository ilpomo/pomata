...
class TestLinearRegressionInterceptContract:
    ...
    def test_returns_expr(self) -> None:
        ...
        """
        assert isinstance(linear_regression_intercept(pl.col(COLUMN_X), 14), pl.Expr)
    ...
    def test_preserves_length_and_dtype(self) -> None:
        ...
        result = frame.select(linear_regression_intercept(pl.col(COLUMN_X), 3).alias("y"))
    ...
    def test_lazy_eager_parity(self) -> None:
        ...
        """
        frame = pl.DataFrame({COLUMN_X: pl.Series(COLUMN_X, [10.0, 11.0, 13.0, 12.0, 14.0])})
        expr = linear_regression_intercept(pl.col(COLUMN_X), 3).alias("y")
...
class TestLinearRegressionInterceptEdge:
    ...
    def test_empty(self) -> None:
        ...
        """
        assert_matches(apply_expr([], linear_regression_intercept(pl.col(COLUMN_X), 3)), [])
