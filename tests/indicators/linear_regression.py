...
LINEAR_REGRESSION = Spec(
    ...
    # The fitted endpoint of the window's least-squares line, homogeneous of degree 1 (tests/indicators/
    # test_linear_regression.py::TestLinearRegressionProperties::test_scale_homogeneity).
