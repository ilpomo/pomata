...
declaration's :class:`~tests.indicators.enums.RelationTalib` axis (``MATCHES`` is compared here, the other two are
...
from tests.indicators.enums import RelationTalib
from tests.support.registry import registry_indicators
from tests.support.tolerances import TOLERANCE_ABSOLUTE_REFERENCE, TOLERANCE_RELATIVE_REFERENCE
