...
from tests_new.indicators.oracles import kama_reference
...
KAMA = Spec(
    ...
    # A degree-1 homogeneous adaptive mean: kama(k*x) == k*kama(x) (tests/indicators/test_kama.py
    # ::TestKamaProperties::test_scale_homogeneity).
    ...
    pins=(
        SpecPin(
            ...
            "on the constant (test_kama.py::TestKamaEdge::test_flat_window_stays_constant)",
        ),
        SpecPin(
            ...
            "seed carried across the gap (test_kama.py::TestKamaEdge::test_interior_null_bridged)",
        ),
    ),
)
