...
from tests_new.indicators.oracles import ema_reference
...
EMA = Spec(
    ...
    # A linear recursive mean scales linearly with the series (tests/indicators/test_ema.py
    # ::TestEmaProperties::test_scale_homogeneity).
    ...
    pins=(
        SpecPin(
            ...
            "(test_ema.py::TestEmaEdge::test_null_bridged)",
        ),
        SpecPin(
            label="nan_latches",
            ...
            "(test_ema.py::TestEmaEdge::test_nan_latches)",
        ),
        SpecPin(
            ...
            "(test_ema.py::TestEmaEdge::test_window_one_is_identity)",
        ),
        SpecPin(
            ...
            "out of the property fuzz (test_ema.py::TestEmaEdge::test_all_zero_series_is_zero)",
        ),
        SpecPin(
            ...
            "(test_ema.py::TestEmaEdge::test_interior_null_bridged)",
        ),
        SpecPin(
            ...
            "(1 - alpha) ** k decay (test_ema.py::TestEmaEdge::test_interior_null_after_seed_bridged)",
        ),
        SpecPin(
            ...
            "(test_ema.py::TestEmaCorrectness::test_golden_master_adjusted)",
        ),
    ),
)
