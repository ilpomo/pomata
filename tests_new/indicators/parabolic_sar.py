...
PARABOLIC_SAR = Spec(
    ...
    # Homogeneous of degree 1 under a positive common rescaling of high and low (tests/indicators/test_parabolic_sar.py
    # ::TestParabolicSarProperties::test_scale_homogeneity).
    ...
    pins=(
        SpecPin(
            ...
            "long-seeding top-level golden never reaches (test_parabolic_sar.py::test_golden_master_short_seed)",
        ),
        SpecPin(
            ...
            "untouched and resumes on the next complete bar (test_parabolic_sar.py::test_golden_master_with_null)",
        ),
    ),
)
