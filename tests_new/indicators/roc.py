...
from tests_new.indicators.oracles import roc_reference
...
ROC = Spec(
    ...
    # A ratio minus one, scale-INVARIANT, degree 0 (tests/indicators/test_roc.py::TestRocProperties
    ...
    pins=(
        SpecPin(
            ...
            expected=(None,),
            reason="a one-element series with window=1 stays undefined (test_roc.py::TestRocEdge::test_single_row)",
        ),
        SpecPin(
            ...
            "(test_roc.py::TestRocEdge::test_window_one_is_single_period_return)",
        ),
        SpecPin(
            label="all_nan",
            ...
            "(test_roc.py::TestRocEdge::test_all_nan)",
        ),
        SpecPin(
            ...
            "(test_roc.py::TestRocEdge::test_constant_series_is_zero)",
        ),
        SpecPin(
            ...
            "(test_roc.py::TestRocEdge::test_zero_lagged_nonzero_change_is_signed_inf)",
        ),
        SpecPin(
            ...
            "(test_roc.py::TestRocEdge::test_zero_lagged_mixed_change)",
        ),
    ),
)
