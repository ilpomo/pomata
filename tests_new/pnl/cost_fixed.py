...
from tests_new.pnl.oracles import cost_fixed_reference
...
COST_FIXED = Spec(
    ...
    # degree 0 (tests/pnl/test_cost_fixed.py::test_scale_invariance).
    ...
    pins=(
        SpecPin(
            ...
            expected=(1.0,),
            reason="a one-element series charges the fee on the entry trade, not null (tests/pnl/test_cost_fixed.py"
            "::test_single_row)",
        ),
        SpecPin(
            ...
            "the next trade off the NaN is NaN (tests/pnl/test_cost_fixed.py::test_null_takes_precedence_over_nan)",
        ),
        SpecPin(
            ...
            "the property tiers set allow_infinity=False (tests/pnl/test_cost_fixed.py"
