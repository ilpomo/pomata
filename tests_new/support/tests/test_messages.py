"""
Self-tests of :mod:`tests_new.support.messages` — the single failure formatter.
...
from tests_new.support.messages import Disagreement, describe_failure, triage_for_enum, triage_generic
from tests_new.support.synthesis import frame_nan_interior
