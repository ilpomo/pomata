"""
Self-tests of :mod:`tests_new.support.registry` — auto-registration and the surface bijection guard.
...
from tests_new.support.registry import assert_bijection, register, registry_pnl
