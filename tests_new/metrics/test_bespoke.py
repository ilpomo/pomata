...
ordinary property tests (the mirror of ``tests_new/pnl/test_bespoke.py``).

A :class:`~tests_new.support.spec.SpecPin` is a fixed crafted case and a :class:`~tests_new.support.spec.ScaleAxis` is
