...
OMEGA_RATIO = Spec(
    ...
    # A ratio of means, scale-invariant (test_omega_ratio.py::test_scale_invariance).
    ...
    pins=(
        SpecPin(
            ...
            "(test_omega_ratio.py::test_single_row)",
        ),
        SpecPin(
            ...
            "(test_omega_ratio.py::test_all_gain_is_inf)",
        ),
        SpecPin(
            ...
            "(test_omega_ratio.py::test_all_loss_is_zero)",
        ),
        SpecPin(
            ...
            "(test_omega_ratio.py::test_all_at_threshold_is_nan)",
        ),
    ),
)
